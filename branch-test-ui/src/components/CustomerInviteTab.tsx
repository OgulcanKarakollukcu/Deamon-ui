...
export default function CustomerInviteTab() {
  ...
  return (
    <section className="grid h-full min-h-0 grid-cols-1 gap-5">
      <article className="rounded-2xl border border-[#DDEFE3] bg-white p-5 shadow-[0_6px_20px_rgba(0,122,61,0.08)] dark:border-[#1f3327] dark:bg-[#15271d]">
      ...
      <article className="min-h-0 rounded-2xl border border-[#DDEFE3] bg-white p-5 shadow-[0_6px_20px_rgba(0,122,61,0.08)] dark:border-[#1f3327] dark:bg-[#15271d]">
        ...
        <div className="min-h-[280px] overflow-auto rounded-xl border border-[#DDEFE3] dark:border-[#1f3327]">
          {listLoading ? (
            ...
            <table className="min-w-full divide-y divide-[#E3EEE7] text-left text-xs dark:divide-[#2b4535]">
