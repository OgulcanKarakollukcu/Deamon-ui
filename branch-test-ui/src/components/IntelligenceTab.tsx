...
export default function IntelligenceTab() {
  ...
  if (detailOpen) {
    return (
      <section className="flex h-full min-h-0 flex-col gap-4">
        <article className="min-h-0 overflow-auto rounded-3xl border border-[#DDEFE3] bg-white/95 p-6 shadow-[0_14px_36px_rgba(0,122,61,0.08)] backdrop-blur-sm dark:border-[#1f3327] dark:bg-[#132017]/95">
  ...
  return (
    <section className="grid h-full min-h-0 grid-cols-1 gap-5">
      <article className="min-h-0 rounded-3xl border border-[#DDEFE3] bg-white/95 p-6 shadow-[0_14px_36px_rgba(0,122,61,0.08)] backdrop-blur-sm dark:border-[#1f3327] dark:bg-[#132017]/95">
        <header className="mb-4 flex flex-wrap items-center justify-between gap-3 border-b border-[#DDEFE3] pb-4 dark:border-[#1f3327]">
          <div className="flex items-center gap-3">
            <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-[#007A3D] text-white">
